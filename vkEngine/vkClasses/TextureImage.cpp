...
TextureImage::TextureImage(std::shared_ptr<FrameBuffers> frameBuffersObj)
{
    ...
    std::shared_ptr<LogicalDevice> logicalDeviceObj = frameBuffersObj->depthResourcesObj->commandPoolObj->graphicsPipelineObj->descriptorSetLayoutObj->renderPassObj->imageViewsObj->swapChainObj->logicalDeviceObj;
    ...
    logicalDeviceObj->createBuffer(imageSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, stagingBuffer, stagingBufferMemory);
