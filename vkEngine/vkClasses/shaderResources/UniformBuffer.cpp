...
{
    uniformBuffers.resize(m_Config->maxFramesInFlight);
    uniformBuffersMemory.resize(m_Config->maxFramesInFlight);
    uniformBuffersMapped.resize(m_Config->maxFramesInFlight);
