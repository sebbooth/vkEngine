...
class HelloTriangleApplication {
    ...
    private:
        ...
        void initVulkan() {
            ...
            swapChainFramebuffers = frameBuffersObj->swapChainFramebuffers;

            textureImageObj = std::make_shared<TextureImage>(frameBuffersObj);
            textureImage = textureImageObj->textureImage;
            textureImageMemory = textureImageObj->textureImageMemory;
        ...
        void copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
            VkCommandBuffer commandBuffer = commandPoolObj->beginSingleTimeCommands();

            VkBufferCopy copyRegion{};
            copyRegion.size = size;
            vkCmdCopyBuffer(commandBuffer, srcBuffer, dstBuffer, 1, &copyRegion);

            commandPoolObj->endSingleTimeCommands(commandBuffer);
        }
